...
if ( ! function_exists( 'starter_setup' ) ) :
	...
	function starter_setup() {
		...
		add_filter( 'acf/settings/show_admin', 'starter_hide_acf_admin' );
 ...
 * Cleanup head
 */
add_action( 'after_setup_theme', 'starter_head_cleanup' );
if ( ! function_exists( 'starter_head_cleanup' ) ) {
...
add_action( 'wp_head', 'starter_javascript_detection', 0 );
